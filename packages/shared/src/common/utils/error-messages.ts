...
export function formatErrorMessage(errorCode: Codes): string {
  switch (errorCode) {
    ...
    case 'auth/user-not_authorized':
      return 'O usuário não tem permissão para continuar.';
    case 'auth/user-not-activated':
      return 'Você ainda não ativou sua conta. Verifique seu e-mail para mais informações.';
    case 'auth/user-disabled':
      return 'O usuário correspondente à credencial fornecida foi desativado. Entre em contato com o administrador';
    case 'auth/unexpected-authorization':
      return 'Verifique suas credenciais e tente novamente.';
    case 'auth/user-not-found':
      return 'O usuário não correponde à nenhuma credencial. Entre em contato com o suporte';
    case 'auth/weak-password':
      return 'A senha é muito fraca.';
    case 'auth/email-already-in-use':
      return 'Já existe uma conta com o endereço de email fornecido.';
    case 'auth/document-already-in-use':
      return 'Já existe uma conta com o CNPJ fornecido.';
    ...
    case 'auth/unsupported-persistence-type':
      return 'O ambiente atual não suporta o tipo especificado para persistência dos dados.';
    ...
    case 'auth/user-token-expired':
      return 'A sua conta já está ativada ou o link de confirmação já expirou';
    case 'auth/null-user':
    ...
    case 'auth/user-not-company':
      return 'O usuário ainda não cadastrou nenhuma empresa';
    case 'auth/google_unexpected-authorization':
      return 'O seu email já foi cadastrado com o Google. Por favor, utilize o Google para acessar a sua conta';
    default:
      return '';
  }
}
